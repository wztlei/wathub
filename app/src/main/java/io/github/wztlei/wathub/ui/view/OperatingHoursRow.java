...
public class OperatingHoursRow extends RelativeLayout {

    @BindView(R.id.view_location_hours_day)
    TextView mDayView;
    @BindView(R.id.view_location_hours_hours)
    TextView mHoursView;
    ...
    public OperatingHoursRow(
        ...
        final TypedArray a =
                context.obtainStyledAttributes(attrs, R.styleable.OperatingHoursRow, defStyleAttr,
                        defStyleRes);
