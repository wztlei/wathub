...
public class ScheduleAdapter extends ArrayAdapter<CourseSchedule> {
    ...
    static class ViewHolder {
        @BindView(R.id.schedule_section)
        TextView section;
        @BindView(R.id.schedule_campus)
        TextView campus;
        @BindView(R.id.schedule_capacity)
        TextView capacity;
        @BindView(R.id.schedule_reserves)
        TextView reserves;
        @BindView(R.id.schedule_held_with)
        TextView heldWith;
        @BindView(R.id.schedule_classes)
