package io.github.wztlei.wathub.ui.modules.events;
...
public class EventFragment extends BaseModuleFragment<Responses.EventDetails, EventInfo> {
    ...
    @BindView(R.id.event_banner_root)
    View mBannerRoot;
    @BindView(R.id.event_spacer)
    View mSpacer;
    @BindView(R.id.event_times)
    ListView mTimesListView;
    @BindView(R.id.event_description)
    TextView mDescriptionView;
    @BindView(R.id.event_open_in_browser_root)
    View mBrowserRoot;
