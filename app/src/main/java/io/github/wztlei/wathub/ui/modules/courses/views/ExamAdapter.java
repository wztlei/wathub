...
public class ExamAdapter extends ArrayAdapter<ExamSection> implements View.OnLongClickListener {
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            view = LayoutInflater.from(getContext()).inflate(R.layout.list_item_exam_section, parent,
                    false);
        ...
        // Title
        final String sectionName = getContext().getString(R.string.exam_section,
        ...
        if (date != null) {
            final String formattedDay = DateUtils.formatDate(getContext(), section.getDate(),
                    DateUtils.DATE_LENGTH_LONG);
    ...
    static final class ViewHolder {
        ...
        View selectable;
        @BindView(R.id.exam_section)
        TextView section;
        @BindView(R.id.exam_date)
        TextView date;
        @BindView(R.id.exam_time)
        TextView time;
        @BindView(R.id.exam_building)
        TextView building;
        @BindView(R.id.exam_rooms)
        TextView rooms;
