...
public class NearbyLocationsFragment extends Fragment implements
        LocationListener,
        PermissionCallback,
    ...
    @BindView(R.id.nearby_locations_root)
    ViewGroup mRoot;
    @BindView(R.id.nearby_locations_enable_permission)
    View mLocationPermission;
    @BindView(R.id.nearby_locations_list)
    ListView mLocationsList;
    @BindView(R.id.nearby_locations_error)
    TextView mErrorView;
