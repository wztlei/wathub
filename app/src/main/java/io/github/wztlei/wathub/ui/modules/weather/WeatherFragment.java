package io.github.wztlei.wathub.ui.modules.weather;
...
import io.github.wztlei.wathub.model.PhotoUrl;
...
public class WeatherFragment extends BaseApiModuleFragment<Responses.Weather, WeatherReading>
    ...
    @BindView(R.id.weather_scrollview)
    ScrollView mScrollView;
    @BindView(R.id.weather_slider)
    SliceView mSliceView;
    @BindView(R.id.weather_background)
    ImageView mBackground;

    @BindView(R.id.weather_temperature_bar)
    View mTemperatureBar;
    @BindView(R.id.weather_temperature)
    TextView mTemperatureView;
    @BindView(R.id.weather_temperature_range)
    ...
    @BindView(R.id.weather_wind_direction_root)
    View mWindDirectionRoot;
    @BindView(R.id.weather_wind_direction)
    View mWindDirectionView;
    @BindView(R.id.weather_wind_speed)
    TextView mWindSpeedView;

    @BindView(R.id.weather_waveview)
    WaveView mWaveView;
    @BindView(R.id.weather_precipitation)
    TextView mPrecipitationView;

    @BindView(R.id.weather_pressure_trend_layout)
    ViewGroup mPressureLayout;
    @BindView(R.id.weather_pressure)
    TextView mPressureDescription;
    @BindView(R.id.weather_pressure_trend)
    TextView mPressureTrend;

    @BindView(R.id.weather_last_updated)
    TextView mLastUpdated;
    @BindView(R.id.weather_spacer)
    View mSpacer;
    @BindView(R.id.weather_author_attribution)
    TextView mAuthor;
    ...
    private static class PhotoFetcher extends AsyncTask<String, Void, Photo> {
        ...
        static void fetchRandom(final WeatherFragment fragment) {
            new PhotoFetcher(fragment).execute((String) null);
        }
